...
// game variables
let startScene;
let gameScene,ship,scoreLabel,lifeLabel,finalScoreLabel,shootSound,hitSound,fireballSound;
let gameOverScene;
...
function setup() {
    ...
    function fireBullet(e){
        ...
        if(score >= 5){
            let b1 = new Bullet(0xFFFFFF,ship.x-16,ship.y);
            let b2 = new Bullet(0xFFFFFF,ship.x,ship.y);
            let b3 = new Bullet(0xFFFFFF,ship.x+16,ship.y);
            bullets.push(b1);
            bullets.push(b2);
            bullets.push(b3);
